import {
  ...
  Button_default2,
  useButtonProps
} from "./chunk-L4ZZ2M3P.js";
import {
  Container_default
} from "./chunk-UGSQD3QE.js";
import {
  ...
  useWillUnmount,
  useWindow
} from "./chunk-2XQA4EUH.js";
import {
  require_react_dom
} from "./chunk-YF4B4G2L.js";
import {
  Badge_default
} from "./chunk-H3M4DXEZ.js";
import {
  CardBody_default,
  CardFooter_default,
  ...
  CardTitle_default,
  Card_default
} from "./chunk-ACBI7XRR.js";
import {
  divWithClassName_default
} from "./chunk-G4ZWMC4G.js";
import {
  DEFAULT_BREAKPOINTS,
...
function map(children, func) {
  let index = 0;
  return React22.Children.map(children, (child) => React22.isValidElement(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  React22.Children.forEach(children, (child) => {
    if (React22.isValidElement(child)) func(child, index++);
  });
}
function hasChildOfType(children, type) {
  return React22.Children.toArray(children).some((child) => React22.isValidElement(child) && child.type === type);
}
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react21.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react22.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react23.useCallback)((nextState) => {
    if (!isMounted()) return;
...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react26.useContext)(DropdownContext_default);
...
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react27.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react27.useState)(true);
  ...
  return (0, import_react27.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react27.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react27.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react27.default).createElement((0, import_react27.default).Fragment, null, props.children);
  }
  return (0, import_react27.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function Dropdown({
  ...
  const context5 = (0, import_react30.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var context3 = React37.createContext(null);
...
var FormLabel = React55.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime50.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
var FormRange = React56.forwardRef(({
  ...
  return (0, import_jsx_runtime51.jsx)("input", {
    ...props,
    type: "range",
    ref,
...
var FormSelect = React57.forwardRef(({
  ...
  return (0, import_jsx_runtime52.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
...
var Switch = React59.forwardRef((props, ref) => (0, import_jsx_runtime54.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React60.forwardRef(({
  ...
  bsPrefix = useBootstrapPrefix(bsPrefix, "form-floating");
  return (0, import_jsx_runtime56.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames41.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime55.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var NavItem2 = React69.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React70.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React71.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarBrand = React72.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React73.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React74.forwardRef(({
  bsPrefix,
  className,
  children,
...
var OffcanvasBody = React75.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React76.forwardRef(({
  ...
  return (0, import_jsx_runtime71.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
...
var OffcanvasTitle = React78.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime74.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React79.forwardRef(({
  ...
  const renderBackdrop = (0, import_react52.useCallback)((backdropProps) => (0, import_jsx_runtime74.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime76.jsxs)(import_jsx_runtime75.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime74.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React80.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context5 = (0, import_react53.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
    context5 == null || context5.onToggle == null || context5.onToggle();
    onHide == null || onHide();
  });
  return (0, import_jsx_runtime77.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React81.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var PopoverHeader = React85.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React86.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React88.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Tooltip = React89.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Overlay2 = React90.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime88.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React90.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React91.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime91.jsxs)(import_jsx_runtime90.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react59.cloneElement)(children, triggerProps), (0, import_jsx_runtime89.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React92.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
...
function createButton(name, defaultValue, label = name) {
  const Button = React92.forwardRef(({
    children,
    ...props
...
var Pagination = React93.forwardRef(({
  bsPrefix,
  className,
  size,
  ...props
  ...
  return (0, import_jsx_runtime94.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames66.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames67.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var Spinner = React99.forwardRef(({
  ...
  return (0, import_jsx_runtime100.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames71.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react61.useContext)(TabContext_default);
...
var Table = React106.forwardRef(({
  ...
  const classes = (0, import_classnames75.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastHeader = React110.forwardRef(({
  ...
  const context5 = (0, import_react63.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
